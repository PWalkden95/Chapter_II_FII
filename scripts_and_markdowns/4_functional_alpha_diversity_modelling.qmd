...
model_1a <- lmer(logRich ~ LUI  + LUI:log_hpd_1km + LUI:nat_hab_sw + LUI:log_roads + LUI:log_T30 +
                  log_hpd_1km + log_roads + nat_hab_sw + log_T30 + control_hpd + control_roads + 
                  (1 + log_hpd_1km|SS) ,data = alpha_data)
...
model_1b <- lmer(logRich ~ LUI  + LUI:log_hpd_1km + LUI:nat_hab_sw + LUI:log_roads + LUI:log_T30 +
                  log_hpd_1km + log_roads + nat_hab_sw + log_T30 + control_hpd + control_roads + 
                  (1 + log_roads|SS) ,data = alpha_data)
...
model_1c <- lmer(logRich ~ LUI  + LUI:log_hpd_1km + LUI:nat_hab_sw + LUI:log_roads + LUI:log_T30 +
                  log_hpd_1km + log_roads + nat_hab_sw + log_T30 + control_hpd + control_roads + 
                  (1 + nat_hab_sw|SS) ,data = alpha_data)
...
model_1d <- lmer(logRich ~ LUI  + LUI:log_hpd_1km + LUI:nat_hab_sw + LUI:log_roads + LUI:log_T30 +
                  log_hpd_1km + log_roads + nat_hab_sw + log_T30 + control_hpd + control_roads + 
                  (1 + log_T30|SS) ,data = alpha_data)
